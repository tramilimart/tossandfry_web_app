...
import FacebookButton from "../component/buttons/facebook_auth_btn.jsx";
...
import CallPhoneNo from '../component/buttons/callPhoneNoBtn.jsx'
...
const SignInPage = () => {
    ...
    return (
        <>
            <img className="z-index-999" src={WaveBg} style={{ position: 'absolute', zIndex: '-1' }} />
            <div className='center-div'>
                <div className='mt-6 mw-330px'>
                    <h3>Welcome to <b>Toss And Fry</b></h3>
                    <p>Discover delicious flavors, cooked fresh and served with love!</p>
                    ...
                    <div className='mt-3'>
                        <div className='field' ref={formRef}>
                            ...
                            <div className='signin-btn email-btn mt-3' onClick={handleSignIn}>
